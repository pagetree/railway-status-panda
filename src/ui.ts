...
.form-grid:has(#keyword-field:not([hidden])) {
  grid-template-columns: 1fr 1.2fr 0.9fr 0.85fr;
}
...
@media (max-width: 720px) {
  ...
  .grid-2, .form-grid, .form-grid:has(#keyword-field:not([hidden])) { grid-template-columns: 1fr; }
  .tab-group {
    display: flex;
    overflow-x: auto;
    flex-wrap: nowrap;
